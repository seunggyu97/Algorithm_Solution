...
class RotateMatrixBorder {
    int[][] matrix;
    public int[] rotateMatrixBorder(int rows, int columns, int[][] queries) {
    ...
    public static void main(String[] args){
        ...
        RotateMatrixBorder sol = new RotateMatrixBorder();
        System.out.println(Arrays.toString(sol.rotateMatrixBorder(rows, columns, queries)));
    }
}
